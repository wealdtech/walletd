...
require (
	...
	github.com/prysmaticlabs/go-bitfield v0.0.0-20200303102624-44e3229cdca3 // indirect
	...
	github.com/wealdtech/go-eth2-wallet-hd/v2 v2.0.0
	github.com/wealdtech/go-eth2-wallet-nd/v2 v2.0.0
